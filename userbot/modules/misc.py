...
async def repo_is_heree(wannaseee):
    ...
    await wannaseee.edit(
        "[Click here](https://github.com/AbOuLfOoOoOuF/ProjectFizilion) to open Forkzilion's GitHub Repo."
    )
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Click here](https://heroku.com/deploy?template=https://github.com/AbOuLfOoOoOuF/ProjectFizilion/tree/dev) to deploy Fizilion Userbot on Heroku."
    )
