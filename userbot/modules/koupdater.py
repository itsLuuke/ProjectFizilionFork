...
async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        try:
            ...
            return repo.__del__()
        await event.edit("`Successfully shifted to Kensur!\n" "Restarting, please wait...`")

        if BOTLOG:
            await event.client.send_message(
                BOTLOG_CHATID, "#SHIFT \n" "Your Fizilion was successfully shifted to Kensur"
            )
...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit(
        "`Successfully force shifted to Kensur!\n" "Bot is restarting... Wait for a second!`"
    )
...
async def upstream(event):
    ...
    if changelog == "" and force_update is False:
        await event.edit(
            f"\n`{KUPDATER_ALIAS} is`  **up-to-date**  `with`  **{KOUPSTREAM_REPO_BRANCH}**\n"
        )
        return repo.__del__()
    ...
    if conf is None and force_update is False:
        ...
        return await event.respond('`do ".kota deploy" to update and shift toKensur`')
    ...
    if force_update:
        ...
        await event.edit("`Shifting Fizilion to Kensur, please wait....`")
    if conf == "deploy":
...
CMD_HELP.update(
    {
        ...
        "\n\n.kota deploy"
        "\nUsage: Force update and shift your Fizilion userbot to Kensur userbot."
    }
)
